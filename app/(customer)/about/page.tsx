    ...
    <main className="min-h-screen bg-gray-50 dark:bg-slate-950 pt-28 pb-12">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl font-semibold text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
        ...
        {/* Company Profile */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden mb-16">
          <div className="md:flex">
            <div className="md:w-1/2 p-8 md:p-12">
              <h2 className="text-2xl md:text-3xl font-semibold md:text-4xl font-bold font-bold text-gray-900 dark:text-gray-100 mb-6">Our History & Vision</h2>
            ...
            <div className="md:w-1/2 bg-gray-200 dark:bg-slate-700 relative min-h-[300px]">
        ...
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-semibold md:text-4xl font-bold font-bold text-center text-gray-900 dark:text-gray-100 mb-12">Executive Management</h2>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition-shadow border-t-4 border-primary">
              <div className="w-32 h-32 bg-gray-200 dark:bg-slate-700 rounded-full mx-auto mb-6 flex items-center justify-center">
                <span className="text-gray-400">Photo</span>
              </div>
              <h3 className="text-2xl md:text-3xl font-semibold font-bold text-gray-900 dark:text-gray-100 mb-2">Chairman / Managing Director</h3>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition-shadow border-t-4 border-primary">
              ...
              <h3 className="text-2xl md:text-3xl font-semibold font-bold text-gray-900 dark:text-gray-100 mb-2">Operations Director</h3>
              <p className="text-gray-500 mb-4">Society Enterprises Pvt. Ltd.</p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Genuine Honda parts and certified mechanics you can count on.</p>
          </div>
          <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm">
            <div className="w-12 h-12 bg-red-100 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Dedicated to making your purchase and servicing journey seamless.</p>
          </div>
          <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm">
            <div className="w-12 h-12 bg-red-100 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Bringing the latest Honda technologies and models to Eastern Nepal.</p>
          </div>
        </div>
