  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-16">
          <div className="md:flex">
            <div className="md:w-1/2 p-8 md:p-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Our History & Vision</h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Executive Management</h2>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition-shadow border-t-4 border-primary">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Chairman / Managing Director</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition-shadow border-t-4 border-primary">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Operations Director</h3>
              <p className="text-gray-500 mb-4">Society Enterprises Pvt. Ltd.</p>
              <p className="text-gray-600 text-sm">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <h4 className="text-xl font-bold mb-2">Trust & Reliability</h4>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <h4 className="text-xl font-bold mb-2">Innovation & Growth</h4>
