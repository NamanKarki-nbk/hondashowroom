...
export default function ProductPageClient({ vehicle }: { vehicle: ProductData }) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-24 items-center">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                <h1 className="text-2xl md:text-3xl font-semibold md:text-4xl font-bold md:text-4xl font-bold md:text-6xl font-bold tracking-tight md:text-7xl xl:text-[7rem] font-black text-gray-900 dark:text-primary-foreground tracking-tighter mb-4 uppercase leading-none">
                  {vehicle.name}
                </h1>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              ...
              >
                ...
                <img 
                  ...
                  alt={vehicle.name} 
                  className="w-full h-full object-contain relative z-10 filter drop-shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:drop-shadow-[0_20px_50px_rgba(0,0,0,0.8)]"
                />
              </motion.div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-background dark:bg-[#111112] border border-gray-200 dark:border-slate-800 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden transition-colors duration-300">
             ...
             <div className="text-center mb-10 relative z-10">
               <h3 className="text-2xl md:text-3xl font-semibold md:text-4xl font-bold font-extrabold text-gray-900 dark:text-primary-foreground mb-4 uppercase tracking-tight flex items-center justify-center gap-3">
