...
import { ArrowLeft, Mail, Lock, User, MessageCircle } from "lucide-react";
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden py-12">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-[#151517] text-gray-500 font-bold uppercase tracking-wide text-xs">Or register with</span>
            </div>
          </div>

          <div className="mt-6 flex gap-4">
             <a href="/api/auth/google" className="flex-1 bg-gray-50 hover:bg-gray-100 dark:bg-black/40 dark:hover:bg-black/60 border border-gray-200 dark:border-gray-700 py-3 rounded-xl flex justify-center items-center gap-2 transition-colors">
             ...
             <Link href="/login" className="flex-1 bg-gray-50 hover:bg-gray-100 dark:bg-black/40 dark:hover:bg-black/60 border border-gray-200 dark:border-gray-700 py-3 rounded-xl flex justify-center items-center gap-2 transition-colors">
