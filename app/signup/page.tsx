      ...
      <div className="w-full max-w-md bg-white dark:bg-[#151517] border border-gray-200 dark:border-gray-800 rounded-3xl p-10 shadow-2xl relative z-10">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex gap-4">
             <button className="flex-1 bg-gray-50 hover:bg-gray-100 dark:bg-black/40 dark:hover:bg-black/60 border border-gray-200 dark:border-gray-700 py-3 rounded-xl flex justify-center items-center gap-2 transition-colors">
