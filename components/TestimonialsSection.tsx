      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="text-center mb-16 xl:mb-24">
          <h2 className="text-4xl md:text-5xl xl:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6 text-gray-900 uppercase">
            HEAR FROM OUR <span className="text-[#c1291A]">RIDERS</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 xl:gap-12 relative z-10">
          ...
          {TESTIMONIALS.map((testimonial, idx) => (
            <motion.div
              ...
              className="bg-[#f3ebdd] rounded-3xl p-8 xl:p-12 shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300"
            >
              <div className="flex items-center space-x-1 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star 
                    key={i} 
                    className={`w-5 h-5 xl:w-6 xl:h-6 ${i < testimonial.rating ? 'fill-[#c1291A] text-[#c1291A]' : 'fill-gray-200 text-gray-200'}`} 
                  />
                ))}
              </div>
              ...
              <div className="flex items-center space-x-4 mt-auto pt-6 border-t border-gray-100">
                ...
                <img 
                  ...
                  className="w-14 h-14 xl:w-16 xl:h-16 rounded-full object-cover border-2 border-[#f3ebdd] shadow-md"
                />
                <div>
